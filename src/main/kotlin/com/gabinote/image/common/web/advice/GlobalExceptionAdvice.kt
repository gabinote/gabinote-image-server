package com.gabinote.image.common.web.advice

import com.fasterxml.jackson.databind.exc.MismatchedInputException
import com.gabinote.image.common.util.log.ErrorLog
import com.gabinote.image.common.web.advice.ExceptionAdviceHelper.getRequestId
import com.gabinote.image.common.web.advice.ExceptionAdviceHelper.problemDetail
...
class GlobalExceptionAdvice {
    ...
    fun handleMaxUploadSizeExceededException(
        ...
        val detail = "Uploaded file size exceeds the maximum allowed size."
        ...
        logger.info { log }
        logger.debug(ex) { "Max upload size exceeded stacktrace [requestId=$requestId]" }
    ...
    fun handleMissingServletRequestPartException(
        ...
        val requestId = getRequestId(request)
        val httpStatus = HttpStatus.BAD_REQUEST
        val detail = "Required request part '${ex.requestPartName}' is missing"
        ...
        logger.info { log }
        logger.debug(ex) { "Missing request part stacktrace [requestId=$requestId]" }
